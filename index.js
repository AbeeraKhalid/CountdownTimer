...
function startTime(val) {
    ...
    setInterval(() => {
        ...
        if (diff_time <= 0) {
            console.log(chalk.magentaBright.bgWhiteBright("CountDownTimer has been completed"));
        ...
        console.log(chalk.blueBright(`${mins.toString().padStart(2, "0")}:${secs
            .toString()
            .padStart(2, "0")}`)); //timer starting value convert into string and also add 0 on starting point
    }, 1000);
}
startTime(input);
